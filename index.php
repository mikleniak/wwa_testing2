...
<body>
   ...
   <!-- <div id="preloader">
                                ...
                                <div class="text-center">
                                    <div class="container h-100">
                                        <div class="row h-100 align-items-center">
                                            ...
                                            <div style="padding-right: 50px"><a href="#contact">Contact Us</a></div>
                                            <div><a href="../portfolio/tubes/index.php">Login</a></div>
                                        </div>
                                    </div>
    ...
    $qGrid = "SELECT * FROM artikel ORDER BY id_artikel";
    ...
    while($tampilGrid = $rGrid->fetch_object()){
      ...
      <li class="text-center" style="padding-top:5px; padding-bottom:15px;">'.$tampilGrid->nama.'</li></ul></div>';
  }
  echo '</div>';
  ?>
